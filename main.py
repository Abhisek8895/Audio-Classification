...
import os
from runtime import main_function,y
...
def prediction():
    ...
    try:
        ...
        return render_template("error.html")
    return render_template("uploaded.html", predicted_result=predicted_result)
...
def recorded_prediction():
    ...
    try:
        ...
        return render_template("error.html")
    return render_template("record_prediction.html", predicted_result = predicted_result)
